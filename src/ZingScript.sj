...
final class ZingScript {
    ...
    private static InetAddress getHostAddrName(final String hostName) {
        ...
        try {
            ...
            iaddr = ZingScript.tcp4Flag ? ZingScript.getIPv4Addr(hostName) : ZingScript.getIPv6Addr(hostName);

            if (hostFlag && iaddr != null) {
                ZingScript.hostName = iaddr.getHostName();
                ZingScript.hostAddr = iaddr.getHostAddress();
                ZingScript.hostFlag = false;
            }
